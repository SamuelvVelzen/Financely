  ...
  return (
    <div className="relative">
      <textarea
        ...
        className={`peer block w-full appearance-none rounded-full border border-darkgrey bg-transparent px-4 pb-2.5 pt-4 text-sm text-dark focus:text-dark focus:outline-none focus:ring-0`}
        placeholder=" "
      />
      <label
